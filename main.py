...
TOKEN = '7310699829:AAFqb5CKO1-XxwY1G0Q0Ge4wFlQFHZETxjA'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [5464427719]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @Felixbbyy ☔")
    else:
        welcome_message = (
            "🎮 **Welcome to the Felix Ultimate Attack Bot!** 🚀\n\n"
            ...
            "📞 Contact the owner on Instagram and Telegram: @Felixbbyy✅\n"
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @Felixbbyy🌷")
